# Homework 2: Simulating Air Pollution Transport

[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

This is the repository for Homework 2 for [BEE 4750](https://viveks.me/environmental-systems-analysis), taught at [Cornell University](https://cornell.edu) in Fall 2003 by [Vivek Srikrishnan](https://viveks.me).
...
- write and use a model to simulate an environmental process;
- evaluate the relative importance of factors driving the dynamics of a process;
- plot simulated model outcomes;
- find and compare model outcomes to regulatory standards.
